...
export default function SubmitForm() {
    ...
    return (<form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <div>
            ...
            <input {...register('credentials')} className="input" placeholder="IBCLC, RN"/>
      ...
      <div>
        ...
        <textarea {...register('bio')} rows={5} className="input resize-none" placeholder="Tell families a little about yourself, your approach, and why you became an IBCLC…"/>
