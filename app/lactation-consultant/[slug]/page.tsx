...
export default async function ListingPage({ params }: Props) {
    ...
    return (<>
      ...
      {!listing.claimed && (<div className="mx-auto mt-4 max-w-2xl rounded-lg border border-yellow-400 bg-yellow-50 px-4 py-3 text-center">
          ...
          <a href={`/claim/${listing.slug}`} className="inline-block rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-700">
            Claim your profile →
          </a>
        </div>)}
